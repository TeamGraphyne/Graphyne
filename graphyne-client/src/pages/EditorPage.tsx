...
const MockToolbar = () => (
        <div className="flex w-full mt-2">
          <div className="flex gap-2">
            {/* Inline toolbar icons horizontally */}
...
const MockProperties = () => (
  <div className="p-4 text-gray-300 space-y-4">
    ...
    <h3 className="text-sm font-bold text-gray-500 uppercase mt-4">
      Appearance
    </h3>
...
const MockLayers = () => (
  <div className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col z-10 transition-all duration-300">
     <div className="p-3 border-b border-gray-800 font-bold text-xs text-gray-500 uppercase tracking-wider">
        Layers
     </div>
    <div className="flex-1 overflow-y-auto">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="px-4 py-2 border-b border-gray-800 text-sm text-gray-300 hover:bg-gray-800 cursor-pointer flex items-center gap-2"
        >
...
export function EditorPage() {
  return (
    <div className="h-screen flex flex-col bg-gray-950 text-white overflow-hidden">
      {/* 1. HEADER (Global Controls + Toolbar) */}
      <header className="h-20 bg-gray-900 border-b border-gray-800 flex flex-col justify-center px-4 z-20">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-xs font-bold rounded text-white transition-colors">
        ...
        {/* Toolbar now horizontal below menu bar */}
<MockToolbar />
      </header>
